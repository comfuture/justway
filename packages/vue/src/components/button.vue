...
// import '@justway/ui/components/button.css';
import { ref, useTemplateRef, onMounted, computed, inject, unref, type MaybeRef } from "vue";
// import color from "color";
// import { useRippleEffect } from "../../composables/use-ripple-effect";
const useRippleEffect = (el: any) => { }
...
const self = useTemplateRef('self') // for root element
const icon = computed(() => {
